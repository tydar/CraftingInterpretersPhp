...
class Parser {
    ...
    {
        if($this->match(TokenType::FALSE)) return new LiteralAst(new Literal(LiteralType::BOOL, false));
        if($this->match(TokenType::TRUE)) return new LiteralAst(new Literal(LiteralType::BOOL, true));
        if($this->match(TokenType::NIL)) return new LiteralAst(new Literal(LiteralType::NIL, null));
